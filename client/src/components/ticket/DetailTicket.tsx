...
interface DetailTicketProps {
  timeshow: timeshow;
  id_movie: string | undefined | null;
...
const DetailTicket: React.FC<DetailTicketProps> = ({ timeshow, id_movie, selectedSeats, handlerNext }) => {
  const [isSeatsSelected, setIsSeatsSelected] = useState(false);
      ...
      <div className="dat-ve-sidebar col-lg-4 col-md-4 col-12 ">
        ...
        <div className="action-type row">
          <div className="col-lg-12">
            ...
            <div className="row pb-2">
              <span className='d-flex align-items-center col-lg-6'><GiRockingChair /> Ghế ngồi</span>
              <span className="col-lg-6">{selectedSeats.map((seat: number | string) => `${seat}`).join(', ')}</span>
            </div>
          </div>
        </div>
        <div className='text-center'>
